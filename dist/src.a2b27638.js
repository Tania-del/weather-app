...
var updateData = function updateData(response) {
  ...
  var speed = response.data.wind.speed;
...
var searchCity = function searchCity(event) {
  event.preventDefault();
  var formInputEl = document.querySelector("#form-input").value;
  var units = "metric";
  var apiKey = "ff302840c34e328a290e351206228b12";
  var apiUrl = "https://api.openweathermap.org/data/2.5/weather?appid=".concat(apiKey, "&q=").concat(formInputEl, "&units=").concat(units);
  axios.get("".concat(apiUrl)).then(updateData);
};
...
var currentButtonEl = document.querySelector("#current-button");
currentButtonEl.addEventListener("click", getCurrentPosition);

var convertToFahrenheit = function convertToFahrenheit(celcium) {
  return Math.round(celcium * 1.8 + 32);
};

var convertToCelcium = function convertToCelcium(fahrenheit) {
  return Math.round((fahrenheit - 32) / 1.8);
};

var onClickFahrenheit = function onClickFahrenheit() {
  var celcium = tempEl.textContent;
...
var onClickCelcium = function onClickCelcium() {
  var fahrenheit = tempEl.textContent;
...
var celciumEl = document.querySelector("#celcium");
var fahrenheitEl = document.querySelector("#fahrenheit");
